...
String strSQL = "SELECT num FROM tblboardplus_3 ORDER BY num DESC";
ResultSet rs = stmt.executeQuery(strSQL);

       strSQL = "SELECT Max(num) FROM tblboardplus_3";
...
strSQL ="INSERT INTO tblboardplus_3 (num, id, contents, writedate)";
