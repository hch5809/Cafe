...
<TABLE border='0' width='600'>
	<TR>
		<TD align='left'>
			<a href="video_modify_pass.jsp?num=<%=num %>">[수정하기]</a>
			<a href="video_delete_pass.jsp?num=<%=num %>">[삭제하기]</a>
		</TD>

		<TD align='right'>
			<a href='video_write.jsp'>[영상등록]</a>
			<a href='video.jsp'>[목록보기]</a>
 		</TD>
	</TR>
</TABLE>

<%
strSQL = "UPDATE video_3 SET readcount=readcount+1 WHERE num = ?";
pstmt = conn.prepareStatement(strSQL);
pstmt.setInt(1, Integer.parseInt(num));
pstmt.executeUpdate();
...
%>
<FORM Name='Plus' Action='plus_video_input.jsp' Method='post'>
...
String strSQL = "SELECT * FROM videoplus_3 WHERE num = " + num;
