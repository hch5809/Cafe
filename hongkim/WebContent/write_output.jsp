...
<TABLE border='0' cellspacing=5 cellpadding=10 width='600'>
   <TR bgcolor='ededed'>
      <TD align='center'>
      <img src=<%="C:/javaproject/hongkim/WebContent/IMG-UP/" + filename %> width="400" height="400"></TD>
   </TR>
   <TR>
...
<TABLE border='0' width='600'>
   <TR>
      <TD align='left'>
         <a href="Album_modify_pass.jsp?num=<%=num %>">[수정하기]</a>
...
strSQL = "UPDATE tblboard_3 SET readcount=readcount+1 WHERE num = ?";
pstmt = conn.prepareStatement(strSQL);
pstmt.setInt(1, Integer.parseInt(num));
pstmt.executeUpdate();
...
String strSQL = "SELECT * FROM tblboardplus_3 WHERE num = '" + num + "'";
